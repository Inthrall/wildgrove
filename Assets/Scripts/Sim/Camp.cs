namespace Wildgrove.Sim
{
    ...
    /// bought once per run for Amber, read by the fold forecast, the
    /// welcome-back sheet, and the journal's page headers. The name is the
    /// run's, not the player's — it folds at Migration with the camp itself.
    ...
    {
        /// <summary>
        /// The unnamed camp's name — what every line called it before a name
        /// could be bought, and what a fresh fold calls it again. Lower case
        /// because it reads mid-sentence far more often than it opens one.
        /// </summary>
