...
namespace Wildgrove.Sim
{
    ...
    public static class Skills
    {
        ...
        public static int Level(GameState state, GameDataAsset data, string skill)
        {
            ...
            return 1 + XpCurve.RungsForXp(xp.baseXp, xp.growth, xp.maxLevel - 1, Xp(state, skill));
        }
        ...
        {
            return XpCurve.RungCost(xp.baseXp, xp.growth, level - 1);
        }
        ...
        {
            return XpCurve.TotalForRungs(xp.baseXp, xp.growth, level - 1);
        }
        ...
        public static double ProgressToNext(GameState state, GameDataAsset data, string skill)
        {
            ...
            return XpCurve.ProgressToNextRung(xp.baseXp, xp.growth, xp.maxLevel - 1, Xp(state, skill));
        }
