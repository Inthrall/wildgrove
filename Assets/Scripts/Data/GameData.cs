...
namespace Wildgrove.Data
{
    ...
    public sealed class GameDataSources
    {
        ...
        public string SabbatsJson { get; set; }
    ...
    public sealed class GameData
    {
        ...
        public WheelDef Wheel { get; private set; }
        ...
        public static GameData Parse(GameDataSources sources)
        {
            ...
            var data = new GameData
            {
                ...
                Wheel = JsonConvert.DeserializeObject<WheelDef>(sources.SabbatsJson, settings),
        ...
        public static GameDataSources ReadSourcesFromFiles(string directory)
        {
            return new GameDataSources
            {
                ...
                SabbatsJson = File.ReadAllText(Path.Combine(directory, "sabbats.json")),
        ...
        public static string ComputeSourceHash(GameDataSources sources)
        {
            ...
            var combined = string.Join("\n\u0000", GameDataAsset.SchemaFingerprint(),
                ...
                sources.PlantersJson, sources.SabbatsJson, sources.TincturesJson, sources.AmbersJson);
